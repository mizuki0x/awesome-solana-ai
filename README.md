...
- [covenant-skill](https://github.com/open-covenant/covenant-skill) - Experimental, devnet-oriented reference skill for authorization boundaries, untrusted-input handling, audit evidence, and witness verification in Solana agent workflows. Not a production wallet or mainnet enforcement layer.
