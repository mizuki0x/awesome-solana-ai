...
- [covenant-skill](https://github.com/open-covenant/covenant-skill) - Give an agent real authority on Solana without babysitting it: every action clears a scoped capability check and enforced budget before it runs, backed by a hash-chained audit and an on-chain anchored witness. Devnet-first.
